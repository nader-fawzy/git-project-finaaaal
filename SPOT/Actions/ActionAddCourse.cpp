...
bool ActionAddCourse::Execute()
{
	...
	Course_Code code = pGUI->GetSrting();  //get course code name
	...
	ActionData actData = pGUI->GetUserAction("Select a year to add coures to: we will just draw coures where user clicks");
	//TODO: add input validation
